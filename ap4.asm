...
; Objetivo do programa: Apagar os LEDs D6, D8, D10 e D13 e acender os LEDs D7, D9, D11 e D14 caso o botão S2 (RB0) não esteja pressionado
;						Acender os LEDs D6, D8, D10 e D13 e apagar os LEDs D7, D9, D11 e D14 caso o botão S2 (RB0) esteja pressionado
;						Este processo irá se repetir em loop infinito realizando testes se o botão está ou não pressionado
...
BOTAO_OFF
    ...
    MOVWF   PORTD          ; Envia o conteúdo de W para o registrador PORTD apagando os LEDs D7, D9, D11 e D14 e acendendo os LEDs D6, D8, D10 e D13  
...
BOTAO_ON
    ...
    MOVWF   PORTD          ; Envia o conteúdo de W para o registrador PORTD acendendo os LEDs D7, D9, D11 e D14 e apagando os LEDs D6, D8, D10 e D13
